...
namespace scan
{
    ...
    constexpr cstr_t ARG_EX_NAME = "scan::ArgEx";

    /// @brief  Argument(s) details key.
    constexpr cstr_t ARGUMENTS_KEY = "Argument(s)";

    /// @brief  Error message details header.
    constexpr cstr_t ERROR_MSG_HEADER = "UNHANDLED EXCEPTION";

    /// @brief  Exception details key.
    constexpr cstr_t EXCEPTION_KEY = "Exception";

    /// @brief  Information details key.
    constexpr cstr_t INFORMATION_KEY = "Information";

    /// @brief  Error origin location details key.
    constexpr cstr_t LOCATION_KEY = "Location";

    /// @brief  Logic exception type name.
    constexpr cstr_t LOGIC_EX_NAME = "scan::LogicEx";

    /// @brief  Null argument exception error message.
    constexpr cstr_t NULL_ARG_EX_MSG = "One or more null arguments.";

    /// @brief  Null argument exception type name.
    constexpr cstr_t NULL_ARG_EX_NAME = "scan::NullArgEx";

    /// @brief  Null pointer argument exception error message.
    constexpr cstr_t NULL_PTR_EX_MSG = "One or more null pointer arguments.";

    /// @brief  Null pointer argument exception type name.
    constexpr cstr_t NULL_PTR_EX_NAME = "scan::NullPtrEx";

    /// @brief  Runtime exception type name.
    constexpr cstr_t RUNTIME_EX_NAME = "scan::RuntimeEx";
}
